...
notasprova: Aluno -> List Float -> List Float
notasprova (_,n1,n2) b = b ++ [n1] ++ [n2]
...
total: Float
total = (List.foldl somamedia 0 medias) / toFloat (List.length turma)
...
notas: List Float
notas = List.foldl notasprova [] turma
